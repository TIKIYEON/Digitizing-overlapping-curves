Each problem has gotten a folder for itself, but the overall method has been iterated throughout. For the newest fully functional method, go to wrapping/wrappingtwotest.py.
