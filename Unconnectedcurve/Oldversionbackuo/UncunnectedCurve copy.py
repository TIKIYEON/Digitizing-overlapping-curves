...
def extractCurves(ima):
    ...
    def trace_curve_with_gradients(skeleton, start_x, start_y, intersection_start, intesection_end):
        ...
        while True:
            ...
            if not neighbors:
                if len(endpoints == 1 or endpoints == 0):
                    endpoints.pop()
                    break
                ...
                for j in range(tempsave,len(endpoints)):
                    ...
                    if tempendpoint[0] > current_x:
                        ...
                        endpoints.pop(tempendpoint)  
                        break
                endpoints.pop(temppoint)
...
testFile = "C:/Users/willi/OneDrive/Skrivebord/Bachelor/Github/Digitizing-overlapping-curves/Unconnectedcurve/test1.tif"
